...
import com.alphaTelecom.service.UslugeService;
...
public class UslugeController {
	...
	@RequestMapping(value = "/administrator/pregledUsluga", method = RequestMethod.GET)
	public String uslugeIzlistajAdminu(Model model) {
		model.addAttribute("usluge", uslugaService.listAllUsluge());
		return "/administrator/pregledUsluga";
	}
	...
	public String saveUsluga(Usluga usluga) {
		...
		return "redirect:/administrator/pregledUsluga";
	}
